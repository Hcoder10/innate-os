...
_SETTINGS_DOUBLE_KEYS = frozenset(
    {
        ...
        "drive_smoothing.time_constant",
        "drive_smoothing.max_acceleration",
        "drive_smoothing.max_deceleration",
        "drive_smoothing.max_angular_acceleration",
        "drive_smoothing.max_angular_deceleration",
        "drive_smoothing.max_jerk",
        "drive_smoothing.max_angular_jerk",
        "drive_smoothing.settle_epsilon",
