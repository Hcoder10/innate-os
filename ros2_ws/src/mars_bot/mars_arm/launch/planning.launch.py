#!/usr/bin/env python3
"""
Planning-only launch file for Mars Arm.
...
def generate_launch_description():
    # ========== Package Paths ==========
    mars_arm_share = get_package_share_directory("mars_arm")
    ...
    with open(urdf_file) as f:
        robot_description_content = f.read()  # noqa: F841
    ...
    kin_path = os.path.join(mars_arm_share, "config", "kinematics.yaml")
    ...
    move_group_node = Node(
        ...
        parameters=[
            robot_description,
            robot_description_semantic,
            {"robot_description_kinematics": kin_params.get("robot_description_kinematics", {})},
            moveit_config,
            {"use_sim_time": False},
