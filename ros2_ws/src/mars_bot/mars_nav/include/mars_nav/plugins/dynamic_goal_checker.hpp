/*
 * Copyright (c) 2026, Mars Robotics
 * All rights reserved.
 *
 * DynamicGoalChecker - A configurable goal checker plugin for Nav2
 */

#ifndef MARS_NAV__PLUGINS__DYNAMIC_GOAL_CHECKER_HPP_
#define MARS_NAV__PLUGINS__DYNAMIC_GOAL_CHECKER_HPP_
...
#endif  // MARS_NAV__PLUGINS__DYNAMIC_GOAL_CHECKER_HPP_
