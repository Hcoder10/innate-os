...
from mars_control.dynamixel import Dynamixel
from mars_control.robot import Robot
...
class LeaderArmNode(Node):
    def __init__(self):
        ...
        dynamixel = Dynamixel.Config(baudrate=baud_rate, device_name=device_name).instantiate()
