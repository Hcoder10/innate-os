...
{chr(10).join(visual_mesh_lines)}{prop_assets}
  ...
  <worldbody>
    ...
    <geom name="ground" type="plane" size="20 20 0.1" pos="0 0 {ground_z}" friction="0.9 0.01 0.001"
          margin="0.007" solref="0.01 1" rgba="0.35 0.35 0.35 1" group="{collision_group}"/>
