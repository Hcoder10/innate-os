...
| `innate-os` | `$INNATE_OS_ROOT/workspace/skills/<skill_name>/` | Built-in skills shipped with innate-os |
...
```
innate-os/<skill_name>  →  $INNATE_OS_ROOT/workspace/skills/<skill_name>/
local/<skill_name>   →  ~/skills/<skill_name>/
```

For code skills, the "directory" is the parent directory containing the `.py` file:
```
innate-os/navigate_to_position  →  $INNATE_OS_ROOT/workspace/skills/navigate_to_position.py
...
| `innate-os/wave` | wave | `$INNATE_OS_ROOT/workspace/skills/wave/` |
| `innate-os/navigate_to_position` | navigate_to_position | `$INNATE_OS_ROOT/workspace/skills/navigate_to_position.py` |
