...
class RobotStateProvider:
    def __init__(
        ...
        *,
        ...
        # (msg, Pose) from the active map authority. Besides avoiding churn,
        # stable identity lets safety-critical skills distinguish a genuinely
        # new localization sample from the 50 Hz reinjection tick.
    ...
    def _inject(self, skill, pairs) -> None:
        ...
        for state_type, getter in pairs:
            ...
            if value is not None:
                ...
                # value. Omitting None here leaves the skill holding the prior
                # mode's AMCL/SLAM pose until another message happens to arrive.
