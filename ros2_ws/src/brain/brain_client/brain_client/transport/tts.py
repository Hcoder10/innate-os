...
class TTSHandler:
    ...
    def _synthesize_to_aplay(self, text: str, voice: dict[str, Any], t_start: float) -> bool:
        ...
        try:
            ...
            # Mirror the clip to clients too (e.g. a remote operator watching the
            # webapp). The browser suppresses this while the robot's mic is open,
            # so they don't hear both the stream and the speaker through the mic.
