...
def generate_launch_description():
    ...
    rviz_node = Node(package="rviz2", executable="rviz2", name="rviz2", output="screen", arguments=["-d", rviz_config])

    return LaunchDescription([robot_state_publisher, visualizer_node, rviz_node])
