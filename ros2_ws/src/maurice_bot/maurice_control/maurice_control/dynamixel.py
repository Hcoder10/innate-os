...
from dynamixel_sdk import *  # Uses Dynamixel SDK library  # noqa: F403
...
class Dynamixel:
    ...
    def connect(self):
        ...
        self.portHandler = PortHandler(self.config.device_name)  # noqa: F405
        # self.portHandler.LA
        self.packetHandler = PacketHandler(self.config.protocol_version)  # noqa: F405
    ...
    def set_I(self, motor_id: int, I: int):  # noqa: E741
