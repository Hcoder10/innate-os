...
See [`sim/README.md`](sim/README.md) for the architecture (the VirtualMars core, the driver, the asset pipeline) and [`sim/launcher/README.md`](sim/launcher/README.md) for the day-to-day workflow.
