    ...
    sections: [
      ...
      },
      {
        ...
        knobs: [
          ...
          { path: ["input_manager_node", P, "stt_vad_threshold"], label: "VAD threshold", default: 0.3, type: "float", doc: "Lower is more sensitive to speech (silero + realtime)", subsection: "Speech to text" },
