...
# /armsdk/model/. resolve(): the containment check below compares resolved
# targets, so the base must be resolved too or a symlinked install
# (colcon --symlink-install) would 404 every model file.
