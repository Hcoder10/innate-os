"""A phone on the study desk -- the graspable replacement for blaze_laptop.
...
aperture is 61 mm, so no agent could ever complete those challenges; lint_grasp
now refuses to score them. Scaling a laptop down to fit would have produced a
50 mm laptop, which is not a laptop.
