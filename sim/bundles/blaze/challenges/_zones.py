...
# and never has to physically reach. sim/bench/lint_reach.py is what caught it,
# and these numbers come from probing the nav grid rather than from the plan.
