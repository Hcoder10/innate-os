"""Mug_Kitchen from the Rounds map (generated by sim/tools/roblox_to_innate.py).
...
PROP = Prop(
    name="rounds_mug_kitchen",
    label="☕",
    title="Mug Kitchen",
    mesh="../objects/rounds_mug_kitchen.obj",
    collision="cylinder",
    size=(0.0425, 0.0475),
    rgba=(0.9686, 0.9647, 0.9529, 1.0),
    rest_z=0.0475,
    drop_z=0.9375,
)
