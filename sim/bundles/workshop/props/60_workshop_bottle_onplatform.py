"""Bottle_OnPlatform from the Workshop map (generated by sim/tools/roblox_to_innate.py).
...
PROP = Prop(
    name="workshop_bottle_onplatform",
    label="🍶",
    title="Bottle OnPlatform",
    mesh="../objects/workshop_bottle_onplatform.obj",
    collision="cylinder",
    size=(0.036, 0.0625),
