"""Bottle_Kitchen from the Household map (generated by sim/tools/roblox_to_innate.py).
...
PROP = Prop(
    name="household_bottle_kitchen",
    label="🍶",
    title="Bottle Kitchen",
    mesh="../objects/household_bottle_kitchen.obj",
    collision="cylinder",
    size=(0.036, 0.0625),
