"""CoffeeTable from the Household map (generated by sim/tools/roblox_to_innate.py).
...
PROP = Prop(
    name="household_coffeetable",
    label="?",
    title="CoffeeTable",
    mesh="../objects/household_coffeetable.obj",
    collision="box",
    size=(0.35, 0.23, 0.013),
    rgba=(0.6706, 0.4941, 0.3059, 1.0),
    rest_z=0.287,
    drop_z=0.297,
)
