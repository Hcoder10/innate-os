...
Usage: uv run decompose_rooms.py [room_name ...]
    (no args = every room found in sim/assets/apartment_split/*.obj)
"""
...
SPLIT_DIR = Path(__file__).resolve().parent.parent / "assets" / "apartment_split"
OUT_DIR = Path(__file__).resolve().parent.parent / "assets" / "apartment_split_v2"
