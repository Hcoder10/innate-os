...
FOV_DEG = 90.0
HORIZON_ROW_FRAC = 0.5  # horizon sits at the image's vertical centre
...
class _TaskStack:
    ...
    def apply(self, update: object) -> None:
        ...
        # _test_taskstack.py before this ever reached a review, not after.
