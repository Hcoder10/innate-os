...
class _BackgroundReasoner(threading.Thread):
    ...
    def __init__(self, call_fn) -> None:
        ...
        self.turn_count = 0
        # Last swallowed reasoning exception, readable off the instance in a
        # post-mortem. Not wired into the episode report -- same visibility-
        # only rationale as _TaskStack.dropped.
    ...
    def run(self) -> None:
        while not self._stop_flag.is_set():
            ...
            except Exception as exc:  # noqa: BLE001 -- the interaction thread must never hang because this one raised
