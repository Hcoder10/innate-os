...
(could be anything). `nemotron_stack_results.json` confirms this column
...
`results/_repeat_bridge_five.json`; the throwaway driver script was not
...
(`_test_taskstack.py` + `_test_decide_checkpoint.py`, 34 assertions as
