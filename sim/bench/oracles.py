...
ORACLES: dict[str, list[tuple]] = {
    ...
    # rounds_deliver_book and household_tour are deliberately ABSENT: they fall
...
MAP_OF = {
    "gallery": ["gallery_ring_tour", "gallery_ladder_reach", "gallery_fetch_mug"],
    "workshop": ["workshop_bench_tour", "workshop_occlusion", "workshop_fetch_gauge"],
    "rounds": ["rounds_narrow_door", "rounds_all_doors", "rounds_find_bathroom", "rounds_deliver_book"],
    "household": ["household_tour", "household_take_orders", "household_fetch_mug"],
}
