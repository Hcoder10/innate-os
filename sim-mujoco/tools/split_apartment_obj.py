...
SIM_WEB = Path(__file__).resolve().parent.parent.parent / "sim-web"
...
if __name__ == "__main__":
    out_dir = Path(sys.argv[1]) if len(sys.argv) > 1 else Path(__file__).resolve().parent.parent / "work" / "apartment_split"
    split(SRC, out_dir)
